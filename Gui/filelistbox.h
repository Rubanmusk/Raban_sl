...
#define FLBOX_FLT_GCODE 		1<<6		//GCODE文件
...
#define FLBOX_DFT_LSELBKCOLOR	ORANGECOL		//0X07E0		//选中list后的背景色
...
//固定宽高度定义
#define FLBOX_SCB_WIDTH 		40		//滚动条宽度为15个像素
#define FLBOX_ICO_HEIGHT		30		//ico图标的高度
#define FLBOX_ICO_WIDTH			30		//ico图标的宽度
#define FLBOX_PATH_HEIGHT		0		  //显示路径的区域高度(在最顶端)
#define FLBOX_ITEM_HEIGHT		40		//每个条目所占高度,默认20
#define FLBOX_FINFO_HEIGHT		0		//底部信息显示栏的高度,默认20


#define FLBOX_PTHINF_FONT 		16		//使用12*12的字体
