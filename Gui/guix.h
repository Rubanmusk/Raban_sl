...
//extern volatile  INT32U  _10ms_Time;
//gui时间计数器,需要在外部实现
//gui定时器,每10ms增加1次
#define GUI_TIMER_10MS  millis()/10

#define GUI_VERSION		101			//gui版本(扩大了100倍),100表示V1.00
//////////////////////////////////////////////////////////////////////////////////////////////
//GUI支持的语言种类数目
//系统语言种类数
#define GUI_LANGUAGE_NUM	   	10			//语言种类数
											//0,简体中文
											//1,繁体中文
											//2,英文
...
extern const u8* GUI_FINISH_CAPTION_TBL[GUI_LANGUAGE_NUM]; 			//完成按钮
extern const u8* GUI_CONTINUE_CAPTION_TBL[GUI_LANGUAGE_NUM]; 			//完成按钮
extern const u8* GUI_AGAIN_CAPTION_TBL[GUI_LANGUAGE_NUM]; 			//完成按钮
////////////////////////////////////////////////////////////////////////////////////////////////////////
//gui颜色定义
...
////////////自定义界面颜色
#define  GUI_TITLE_BACKCOL   title_backgroundcol// 
#define  GUI_ICON_FONTCOL    title_fontcol// 
#define  GUI_BODY_BACKCOL    body_backgroundcol// 
////////////自定义界面颜色
#define  GREENCOL   gui_color_chg(0X91D101)//GREENCOL  浅绿
#define  REDCOL     gui_color_chg(0XFF4747)//REDCOL 洋红
#define  ORANGECOL  gui_color_chg(0XFFA012)//ORANGECOL 橙色
#define  BLUECOL    gui_color_chg(0X00C5BE)//BLUECOL 浅蓝 
...
void gui_draw_single_color_icos(u16 x,u16 y,u16 width,u16 height, u8 *index,u16 pen_color,u16 back_color);//20150909
void gui_draw_color_bmp(u16 x,u16 y,u16 width,u16 height,u8 *index);//20160522
