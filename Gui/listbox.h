...
#define LBOX_DFT_LSELBKCOLOR	ORANGECOL		//选中list后的背景色
#define LBOX_DFT_LNCOLOR		0X0000		//未选中的list字体颜色
#define LBOX_DFT_RIMCOLOR		0XF800		//边框颜色

////listboxtype
#define LBOX_TYPE_RIM 			0X01		//有边框的
#define LBOX_ITEM_HEIGHT		40//0X14		//每个条目所占高度为20
//滚条宽度
#define LBOX_SCB_WIDTH 			40//0X0E		//滚动条宽度为15个像素
