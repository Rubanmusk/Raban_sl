...
//滚动条尺寸设定
#define SCROLLBAR_PART_LEN 		30			//两端按钮的长度(即宽度)
...
//滚动条默认颜色 
#define SCLB_DFT_INBKCOLOR		ORANGECOL		//填充色A颜色
#define SCLB_DFT_BTNCOLOR		  GREENCOL    //LIGHTBLUE//0X2DDA //0X031F		//填充色B颜色 
//#define SCLB_DFT_INBKCOLOR		0XFFFF		//填充色A颜色
//#define SCLB_DFT_BTNCOLOR		LGRAY//LIGHTBLUE//0X2DDA //0X031F		//填充色B颜色
//#define SCLB_DFT_RIMCOLOR		0X4A49		//边框颜色
#define SCLB_DFT_RIMCOLOR		  0XC618		//边框颜色 灰色
