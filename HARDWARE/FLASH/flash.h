...
void SPI_Flash_ReadAddr_start(u32 ReadAddr);	//SPI FLASH 连续读开始   
u8 SPI_Flash_continue_data(void);	//SPI FLASH 连续读数据
void SPI_Flash_ReadAddr_end(void);	//SPI FLASH 连续读结束
