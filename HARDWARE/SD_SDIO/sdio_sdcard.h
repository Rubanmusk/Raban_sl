...
#define SDIO_TRANSFER_CLK_DIV    0x06		//SDIO传输频率，最大24Mhz(4bit)。该值太小可能会导致读写文件出错 
...
//#define SD_CD PCin(2)	//SD卡插入检测
#define SD_CD  PAin(15) //GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_15)	//SD卡插入检测
//SDIO 各种错误枚举定义
typedef enum
{	 
	//特殊错误定义 
