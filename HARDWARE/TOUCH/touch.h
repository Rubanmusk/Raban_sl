...
#define SAVE_ADDR_BASE    (5*1024+24)*1024
//#define  LCD_SCANDIR_ADRASS  SAVE_ADDR_BASE+100 
//#define  SAVE_ADDR_BASE2  SAVE_ADDR_BASE+128
...
//电阻屏芯片连接引脚	   
#define PEN  		PBin(9)  	//PC4 INT
#define T_CS  		PBout(8)  	//PA4  CS  
   
//电阻屏函数
u8 TP_Write_Byte(u8 num);						//向控制芯片写入一个数据
